...
function GestionAnalyse() {
    ...
    const fetchAnalyses = async (page = 1) => {
        ...
        try {
            ...
            setToastType('error');
            setToastMessage('Erreur lors du chargement des analyses');
                        ...
                        {analyses.length === 0 ? (
                            ...
                            analyses.map((analyse, idx) => (
                                <tr key={analyse.id}>
                                    ...
                                    <td>{analyse.nom_demandeur}</td>
                                    <td>{analyse.code}</td>
                                    <td>{analyse.duree}{analyse.duree_type}</td>
                                    <td>{analyse.cout}</td>
                                    <td>{analyse.is_active ? "Actif" : "Inactif"}</td>
